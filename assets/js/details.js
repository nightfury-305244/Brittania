var carousel = (function () {
 ...
 function init() {
   ...
   updateCarouselWidth();
   $navDots.css({'width': (20 * carousel_count) + 'px'});
 ...
 function updateCarouselWidth() {
       itemW = $(".carousel_container").width();  // Update the width based on the container
       $carouselItems.css({'width': (itemW * carousel_count) + 'px'});  // Update the carousel width
       navigateSlide();  // Adjust the position based on the new width
   }
