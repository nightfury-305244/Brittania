<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Brittania Estates | Properties In Rwanda</title>
        <meta name="description" content="BUY/SELL/RENT/MANAGE. Explore the ultimate destination for finding your dream property in Rwanda with Brittania, a British based company. <br>
    ...
    <body>
        ...
        <main class="main">
                ...
                <div class="home__container container grid">
                    <div class="home__data">
                        <h1 class="home__title">
                            Discover <br> Your Ideal <br> Property
                        </h1>
            ...
            <section id="home" class="home bg-overlay">
                <div class="home__container">
                    <div class="home__row">
                        <div class="home_data home__orbe">
                            <h1  class="home__title">
                ...
                <div class="shape-bottom">
                    <svg id="Layer_1" x="0px" y="0px" viewBox="0 0 1921 819.8" style="enable-background:new 0 0 1921 819.8;" xml:space="preserve">
                ...
                <div class="value__container container grid">
                    ...
                    <div class="value__content">
                        <div class="value__data">
                            <span class="section__subtitle">Value</span>
                            <h2 class="section__title">
                                Value We Provide<span>.</span>
                            </h2>
                            <p class="value__description">
                                We always ready to help by providing the best service for you. 
                                We believe a good home will make your life better and happier.
                            </p>
                        </div>
                        ...
                        <div class="value__accordion">
                            <div class="value__accordion-item">
                                <header class="value__accordion-header">
                                    ...
                                    <h3 class="value__accordion-title">
                                        Best return on investment (ROI) on the market
                                    </h3>
                                ...
                                <div class="value__accordion-content">
                                    <p class="value__accordion-description">
                                        The prices we provides is the best for sellers and buyers.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="value__accordion-item">
                                ...
                                <div class="value__accordion-content">
                                    <p class="value__accordion-description">
                                        We are fortunate that recent years have offered periods
                                        of stability and limited exposure to cost increases. 
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="value__accordion-item">
                                ...
                                <div class="value__accordion-content">
                                    <p class="value__accordion-description">
                                            We can guarantee that we have best price on the 
                                            market for all different properties. 
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="value__accordion-item">
                                ...
                                <div class="value__accordion-content">
                                    <p class="value__accordion-description">
                                        We guarantee your personal information is secure
                                        and we abide by General Data Protection Regulation (GDPR)
